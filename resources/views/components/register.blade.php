<div x-cloak x-show="showRegisterModal" @keyup.escape.window="$refs.closeRegisterModalBtn.click()" class="absolute top-[50%] left-1/2 right-1/2 w-[95%] h-[375px] sm:w-[525px] -translate-y-1/2 -translate-x-1/2 bg-stone-300 rounded text-slate-700 p-4 border-2 border-indigo-500 z-10">
